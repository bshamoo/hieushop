      ...
      >
        <Container>
          <Navbar.Collapse
            ...
            className="order-1 order-md-0 order-lg-0"
          >
            <Nav className="mr-auto">
              <Row className="text-center">
                <Col xs={12} md={6} className="pb-3 py-md-0 py-lg-0">
                  <Nav.Item>
                    <a
                      className="social"
                      target="_blank"
                ...
                <Col xs={12} md={6}>
                  <Nav.Item className="pl-md-1 pr-md-4 mr-md-1">
                    <a
                      className="social"
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <Navbar.Toggle
            ...
            className="mr-auto order-0 order-xs-1 order-md-0 order-lg-0"
          />
